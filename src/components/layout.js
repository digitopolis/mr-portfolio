...
export default ({ children }) => (
  <div style={{ margin: `3rem auto`, maxWidth: 1000, padding: `0 1rem` }}>
    <Helmet>
      ...
      <meta
        name="keywords"
        content="Web Developer, Software Engineer, JavaScript, React, Ruby, Rails"
      />
    ...
    <header style={{ marginBottom: `3rem` }}>
      ...
      <ul
        style={{ listStyle: `none`, float: `right`, marginBlockStart: `.5em` }}
      >
        <ListLink to="/">About</ListLink>
        <ListLink to="/experience/">CV/Projects</ListLink>
